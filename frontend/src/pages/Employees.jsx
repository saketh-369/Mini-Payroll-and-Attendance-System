...
export default function Employees() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setForm({ name: '', email: '', password: '', role: 'EMPLOYEE', work_type: 'Office', salary_type: 'monthly', salary_amount: '' });
      fetchEmployees();
    } catch (err) {
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <input id="emp-email" type="email" name="email" value={form.email} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label htmlFor="emp-password">Password</label>
              <input id="emp-password" type="password" name="password" value={form.password} onChange={handleChange} required />
            </div>
            <div className="form-group">
              <label htmlFor="emp-role">Role</label>
              <select id="emp-role" name="role" value={form.role} onChange={handleChange}>
